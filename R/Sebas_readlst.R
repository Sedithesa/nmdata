...
#' Extract items from .lst and .ext files
#'
#' @param run Run number. Make sure you are in the right directory /(setwd/(/)/)
#'
#' @return OFV, cond_nr, run_date,final_est,term_message, etabar
#' @export
#'
...
extract <- function(run){
  ...
  results <- list(OFV=OFV_nr, cond_nr = cond_nr, run_date=run_date,final_est = finalest,
                  term_message=termMsg, etabar = ETAbar_p)
