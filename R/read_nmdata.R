...
#' @param file NONMEM output file(s)
#' @param skip Value specifying number of lines to skip before reading data.
#' @param header Logical value indicating whether the file contains the names of the variables as its first line
#' @param rm_duplicates Logical value indicating whether duplicated columns should be removed
#' @param nonmem_tab Logical value indicading to the function whether the file is a table or a nonmem additional output file.
#'
#' @return A \code{data.frame}
#' @export
#' @example
#'  \dontrun{
#' data <- read_nmdata(file = '../models/pk/sdtab101')
#' }


read_nmdata <- function(
    file = NULL,
    skip = NULL,
    header = NULL,
    rm_duplicates = FALSE,
